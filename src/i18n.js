...
export const UI = {
  fr: {
    ...
    compileOk: '✅ Compilé pour Arduino Uno.\n',
    ...
    flashPick: '🎯 Choisis ton port série (la carte branchée).\nDéclenche aussi le chrono du bootloader.\nBootloader optiboot: 1,5 s pour démarrer à 115200 baud.',
  ...
  en: {
    ...
    compileOk: '✅ Compiled for Arduino Uno.\n',
